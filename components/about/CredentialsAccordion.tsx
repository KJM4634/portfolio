...
export default function CredentialsAccordion() {
  ...
  return (
    <div className="mt-4 border-t border-border">
      ...
      >
        <span className="font-heading text-base font-medium text-foreground transition-colors duration-300 group-hover:text-accent">
          자격증 및 수상
        </span>
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-border text-muted transition-all duration-300 group-hover:scale-110 group-hover:border-accent/60 group-hover:text-accent">
          <motion.span
